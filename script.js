...
const heroes = {
  ...
  const UKRF = [
  { label: 'УК РФ 1', text: 'Нанесение телесных повреждений гражданскому лицу: лишение свободы на 1 год.' },
  { label: 'УК РФ 2', text: 'Нанесение телесных повреждений государственному служащему: лишение свободы на 2 года.' },
  { label: 'УК РФ 3', text: 'Убийство гражданского лица: лишение свободы на 4 года.' },
  { label: 'УК РФ 4', text: 'Убийство государственного служащего: лишение свободы на 5 лет.' },
  { label: 'УК РФ 5', text: 'Попытка угона транспортного средства любой категории: лишение свободы на 1 год.' },
  { label: 'УК РФ 6', text: 'Угон транспортного средства любой категории: лишение свободы на 2 года.' },
  { label: 'УК РФ 7', text: 'Использование наркотических веществ: лишение свободы на 2 года.' },
  { label: 'УК РФ 8', text: 'Приобретение, хранение, передача, сбыт наркотических веществ: лишение свободы на 3 года.' },
  { label: 'УК РФ 9', text: 'Ношение и использование огнестрельного оружия без лицензии: лишение свободы на 2 года.' },
  { label: 'УК РФ 10', text: 'Незаконное приобретение, передача, сбыт огнестрельного оружия: лишение свободы на 3 года.' },
  { label: 'УК РФ 11', text: 'Проникновение на частную территорию: лишение свободы на 2 года.' },
  { label: 'УК РФ 12', text: 'Проникновение на территорию объекта закрытого режима (воинская часть, ФСИН): лишение свободы на 4 года.' },
  { label: 'УК РФ 13', text: 'Помеха работе сотрудникам правоохранительных органов: лишение свободы на 1 год.' },
  { label: 'УК РФ 14', text: 'Неподчинение сотруднику правоохранительных органов: лишение свободы на 2 года.' },
  { label: 'УК РФ 15', text: 'Попытка/дача взятки государственному служащему: лишение свободы на 2 года.' },
  { label: 'УК РФ 16', text: 'Получение взятки лицом государственного служащего: лишение свободы на 5 лет.' },
  { label: 'УК РФ 17', text: 'Ограбление гражданского либо государственного служащего: лишение свободы на 3 года.' },
  { label: 'УК РФ 18', text: 'Похищение/захват гражданского либо государственного служащего: лишение свободы на 3 года.' },
  { label: 'УК РФ 19', text: 'Деятельность членов организованной преступной группировки: лишение свободы на 4 года.' },
  { label: 'УК РФ 20', text: 'Организация/призыв к совершению/исполнению теракта: лишение свободы на 6 лет.' },
];
...
const FP = [
  {label: 'ФП 1.1', text: 'Нарушение должностных полномочий;'},
  {label: 'ФП 1.2', text: 'Оскорбление граждан;'},
  {label: 'ФП 1.3', text: 'Нахождение в казино или на Б/У рынке в рабочее время;'},
  {label: 'ФП 1.4', text: 'Использование оружия в личных целях;'},
  {label: 'ФП 1.5', text: 'Нахождение в розыске;'},
  {label: 'ФП 1.6', text: 'Сотрудничество с криминальными организациями;'},
  {label: 'ФП 1.7', text: 'Ношение запрещённых аксессуаров;'},
  {label: 'ФП 1.8', text: 'Хранение и использование запрещенных веществ.'},

  {label: 'Правительство ФП 2.1', text: 'Нарушение ценовой политики выдачи лицензий;'},
  {label: 'Правительство ФП 2.2', text: 'Освобождение заключённых вне территории КПЗ или территории свиданий ФСИН.'},

  {label: 'ГИБДД и УМВД ФП 3.1', text: 'Использование транспорта / маяков / сирен в личных целях;'},
  {label: 'ГИБДД и УМВД ФП 3.2', text: 'Объявление розыска не по УК или без причины;'},
  {label: 'ГИБДД и УМВД ФП 3.3', text: 'Препятствие правосудию / проверке;'},

  {label: 'Армия ФП 4.1', text: 'Использование фракционного транспорта в личных целях;'},
  {label: 'Армия ФП 4.2', text: 'Оставление территории воинской части в форме без причины;'},
  {label: 'Армия ФП 4.3', text: 'Открытие огня без причины за пределами воинской части.'},

  {label: 'ФСИН ФП 5.1', text: 'Освобождение заключённых без причины;'},
  {label: 'ФСИН ФП 5.2', text: 'Неадекватное поведение в адрес заключённых.'},
];

// Функция для вывода списка в UL
function renderList(items, containerId) {
  const container = document.getElementById(containerId);
  if (!container) return;

  container.innerHTML = items.map(item => 
    `<li><strong>${item.label}:</strong> ${item.text || item.value}</li>`
  ).join('');
}

document.addEventListener('DOMContentLoaded', () => {
  renderList(UKRF, 'ukrf-basic-info');
  renderList(KOAP, 'koap-articles', true);
  renderList(FP, 'fp-articles');
});
